...
header("location:cetak.php?cek_in=$cek_in&cek_out=$cek_out&jml_kamar=$jml_kamar&nama_pemesan=$nama_pemesan&email_pemesan=$email_pemesan&hp_pemesan=$hp_pemesan&nama_tamu=$nama_tamu&id_kamar=$id_kamar");
?>